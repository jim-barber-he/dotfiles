...
then
	...
	# Set the suggestion colour to a dull grey.
...
[[ $TERM = xterm-ghostty && -d /usr/share/ghostty/shell-integration && -z $_ghostty_state ]] \
	&& source /usr/share/ghostty/shell-integration/zsh/ghostty-integration

# Kitty terminal shell integration
if [[
	$TERM = xterm-kitty
	&& -d /usr/lib/kitty/shell-integration
	&& ${fpath[(Ie)/usr/lib/kitty/shell-integration/zsh/completions]}
]]
then
